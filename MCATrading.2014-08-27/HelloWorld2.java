...
public class HelloWorld2 extends AbstractJob {
	...
	public void onMarketBidAsk(MarketBidAskMessage msg) {
		...
		log(String.format("MarketBidAsk: %1$d x %2$.3f    %3$.3f x %4$d", prices.bid_size, prices.bid, prices.ask, prices.ask_size));
	}
